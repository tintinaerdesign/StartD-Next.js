...
const Lessons = [
    ...
    },
    {
        title : "Ai Insights",
        icon: Rocket,
        description: "let's see the power of technology!",
        link: "/ai",
...
export default function LearnExplore(){
    return (
        <section className="bg-black/20 mt-24 mb-20 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] px-8">
                    {/* Left Content */}
                    <div className="flex flex-col justify-center">

                        <div className="text-3xl text-pink-500 font-['Orbitron']"> Explore Web App More
                        ...
                        {Lessons.map((item, index) => {
                            ...
                            return(
                                <motion.div key={item.title}
                                            ...
                                            className="group relative h-[400px] border border-pink-500/30 rounded-[36px] overflow-hidden">
                                    {/* Link Layer z-30*/}
                                    ...
                                    <Image src={item.image}
                                            ...
                                            fill
                                           priority
                                           className="z-0 object-cover opacity-100 group-hover:scale-110 duration-700 transition"
